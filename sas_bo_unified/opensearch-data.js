/* ==================================================================
   ...
   Le champ `modalite` (via MSP / via CPTS) est porté par l'ADRESSE,
   pas par l'offre. `structureName` porte le nom de la MSP/CPTS.
   ================================================================== */
const OS_INDEX = [
  { rpps:"10108275248", psa:"ROR-COMMUN-FR-NOR-10108275248-389907520400011", etbGuid:"ROR-COMMUN-FR-NOR-389907520400011",
    ...
    agreements:"c1", mssante:"heloise.legouix@chirurgien-dentiste.mssante.fr", modalite:"MSP", structureName:"MSP de Saline" },
  ...
  { rpps:"10106917841", psa:"ROR-COMMUN-FR-NOR-10106917841-394982229000019", etbGuid:"ROR-COMMUN-FR-NOR-394982229000019",
    ...
    agreements:"c1", mssante:"", modalite:"CPTS", structureName:"CPTS du Cotentin" },
  ...
  { rpps:"10002875374", psa:"ROR-COMMUN-FR-OCC-10002875374-10002875374039", etbGuid:"ROR-COMMUN-FR-OCC-10002875374039",
    ...
    agreements:"c1", mssante:"frederic.chapelle@medecin.mssante.fr", modalite:"MSP", structureName:"MSP du Capitole" },
  ...
  { rpps:"10002921293", psa:"ROR-COMMUN-FR-OCC-10002921293-10002921293027", etbGuid:"ROR-COMMUN-FR-OCC-10002921293027",
    ...
    agreements:"c1", mssante:"mohammed.hassaine@medecin.oc.mssante.fr", modalite:"CPTS", structureName:"CPTS Toulouse Métropole" },
  ...
  { rpps:"10111259189", psa:"ROR-COMMUN-FR-OCC-10111259189-10003624557015", etbGuid:"ROR-COMMUN-FR-OCC-10003624557015",
    ...
    agreements:null, mssante:"", modalite:"MSP", structureName:"MSP de Sète" },
  ...
  { rpps:"10107871880", psa:"ROR-COMMUN-FR-OCC-10107871880-10005304711002", etbGuid:"ROR-COMMUN-FR-OCC-10005304711002",
    ...
    agreements:"c1", mssante:"", modalite:"CPTS", structureName:"CPTS Toulouse Sud" },
  ...
  { rpps:"10005294912", psa:"ROR-COMMUN-FR-OCC-10005294912-10005294912016", etbGuid:"ROR-COMMUN-FR-OCC-10005294912016",
    ...
    region:"FR-OCC", phones:[], profession:"70", specialities:[], establishmentType:"SA08",
    agreements:"c1", mssante:"", modalite:"MSP", structureName:"MSP Cœur Montpellier" },
  ...
  { rpps:"10005294912", psa:"ROR-COMMUN-FR-OCC-10005294912-10005294912024", etbGuid:"ROR-COMMUN-FR-OCC-10005294912024",
    ...
    agreements:"c1", mssante:"", modalite:"CPTS", structureName:"CPTS Montpellier Métropole" },
  ...
  { rpps:"10109340603", psa:"ROR-COMMUN-FR-OCC-10109340603-10005297295013", etbGuid:"ROR-COMMUN-FR-OCC-10005297295013",
    ...
    region:"FR-OCC", phones:[], profession:"70", specialities:[], establishmentType:"SA08",
    agreements:"c1", mssante:"", modalite:"MSP", structureName:"MSP d'Albi" },
  ...
  { rpps:"10107646639", psa:"ROR-COMMUN-FR-OCC-10107646639-10005298525004", etbGuid:"ROR-COMMUN-FR-OCC-10005298525004",
    ...
    agreements:"c1", mssante:"", modalite:"CPTS", structureName:"CPTS du Piscénois" },
];
...
/* Spécialité — affichée uniquement pour les médecins (profession "10") */
const OS_SPECIALITY_LABEL = {
 ...
 *  Chaque offre porte : statut de disponibilité, date d'inscription
 *  SAS, historique des modifications, et une ou plusieurs adresses
 *  (« places ») avec modalité de participation, source de la donnée
 *  (index / remplacée en base) et score de géolocalisation.
 * ------------------------------------------------------------------ */
const OS_KIND_LABEL = {
...
/* Seuil en-deçà duquel l'adresse n'est pas affichée dans les résultats de recherche du SAS */
const OS_GEO_MIN_VISIBLE = 70;
...
function osEnrichOffre(o, i, importAuthor) {
  ...
  o.places.forEach((p, k) => {
    ...
    p.indexSnapshot = {
      address: { ...p.address },
      phone: (p.phones[0] && p.phones[0].number) || "",
  ...
  OS_INDEX.forEach(d => {
    if (!map.has(d.rpps)) {
      map.set(d.rpps, { kind: "ps", id: "ps-" + d.rpps, rpps: d.rpps,
        ...
        specialities: (d.specialities || []).slice(),
    ...
    o.places.push({
      ...
      modalite: d.modalite,
      structureName: d.structureName || null,
      geoScore: null,
    });
  });
